  ...
  return (
    ...
    >
      <div className="relative flex flex-col h-full">
        <div
          className={`relative aspect-square overflow-hidden rounded-xl border-2 transition-all duration-300 shine-card ${isSelected
        ...
        <button
          onClick={onClaim}
          className="w-full mt-2 py-2.5 rounded-xl text-base uppercase font-bold tracking-widest border-2 transition-all duration-200 leading-none"
          style={{
            ...
            borderColor: isSelected ? "#FFD700" : "rgba(255,215,0,0.4)",
            boxShadow: isSelected ? "0 2px 12px rgba(255,215,0,0.4)" : "none",
          }}
        >
          Claim
        </button>
  ...
  return (
    <>
      ...
      <main className="relative z-0 flex justify-center">
        <div className="w-full max-w-lg flex flex-col px-4 pt-6 pb-6 glass-panel">
          ...
          {/* ── UID Input ── */}
          <div
            className={`relative flex items-center mb-6 px-4 py-3 rounded-2xl border-2 transition-all duration-300 ${uidError
          ...
          {/* ── Rewards Grid — normal flow, no inner scroll ── */}
          ...
          {/* ── Claim Button — flows normally with page ── */}
      ...
      {/* ── Toast Popup ── */}
      <div
        className={`fixed inset-0 z-50 flex items-center justify-center transition-all duration-300 ${showToast ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none"}`}
        style={{ background: "rgba(0,0,0,0.7)", backdropFilter: "blur(6px)" }}
        onClick={closeToast}
      >
        <div
          className={`relative w-[88%] max-w-sm flex flex-col items-center text-center rounded-3xl border-2 transition-all duration-300 overflow-hidden ${showToast ? "scale-100 translate-y-0" : "scale-75 translate-y-8"}`}
          style={{
