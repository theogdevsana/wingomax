  ...
  return (
    <div className={`${styles.root} pb-20`}>
      ...
      <div className="space-y-6">
        ...
        {/* SEO Settings Card */}
        <div className={`${styles.card} p-5 shadow-sm bg-slate-50/50`}>
          <h2 className="text-sm font-bold text-slate-800 border-b border-slate-200 pb-3 mb-4">SEO / Meta settings</h2>
          <div className="grid grid-cols-1 gap-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={2}
                placeholder={form.description || "Short description for search engines"}
                className="w-full mt-1.5 rounded-lg border border-slate-200 px-3 py-2 text-sm resize-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all"
              />
            </div>
            <div>
        ...
        <div className={`${styles.card} p-5 shadow-sm`}>
          ...
          {form.faqs.length === 0 ? (
            ...
            <div className="space-y-4">
              {form.faqs.map((faq, i) => (
                <div key={i} className="relative p-4 bg-white rounded-xl border border-slate-200 shadow-sm group hover:border-indigo-200 transition-all">
                  <button
                    type="button"
                  ...
                  <div className="pr-10 space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all font-medium text-slate-800"
                      />
                    </div>
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm resize-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 transition-all text-slate-600"
                      />
                    </div>
                  </div>
                </div>
