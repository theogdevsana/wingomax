                ...
                "itemListElement": [
                  {
                    ...
                    "position": 1,
                    "name": "Home",
                    "item": "https://wingosignal.com"
                  },
                  {
                    "@type": "ListItem",
                    "position": 2,
                    "name": `Wingo ${gameLabel} Prediction`,
                    "item": `https://wingosignal.com/${MODE_TO_SLUG[mode]}`
                  }
                ]
              }
            ]
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-slate-900/90 backdrop-blur-sm">
            ...
            >
              ...
              <div className="flex flex-col items-center gap-4 text-center">
                ...
                <Link href="/" className="w-full bg-indigo-600 text-white py-3.5 rounded-2xl font-black shadow-lg">Go Premium</Link>
